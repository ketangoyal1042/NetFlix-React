...
const Header = () => {
  ...
  return (
    <div className="absolute px-8 py-2 bg-gradient-to-b from-black w-screen z-40 flex justify-between flex-col md:flex-row">
      <img src="../images/Netflix_Logo_PMS.png" alt="netfix" className="w-40 mx-auto md:mx-0" />
      {authAuth!=null ? <div className="profile my-auto flex ">
        ...
        <button className="font-bold text-white mx-1 md:mx-3 my-2 px-3 py-2 bg-red-600 hover:bg-red-700 rounded-sm" onClick={handleGptSearchClick}>{!showGPTPage?'GPT Search':"Home Page"}</button>
        <button className="font-bold text-white mx-1 md:mx-3 my-2 px-3 py-2 bg-red-600 hover:bg-red-700 rounded-sm" onClick={handleSignOut}>(Sign Out)</button>
      </div>:
      <div className="profile my-auto flex mx-auto md:mx-0">
